...
get_unique_location_info_data: str = """SELECT DISTINCT(location_name), CAST(latitude as float), CAST(longitude as float), air_quality_level from info_air_pollution"""
